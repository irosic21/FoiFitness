...
namespace BusinessLogicLayer
{
    public class ExerciseRepository
    {
        ...
        {
            return excerciseDAO.GetExcerciseByID(excerciseID).ToList()[0];
        }
        ...
        public List<Exercis> GetAllFilteredExcercisesMOCK()
        {
            ...
            bodyParts = bodyPartDAO.GetAll().ToList();

            EquipmentDAO equipmentDAO = new EquipmentDAO();
            List<Equipment> equipments = new List<Equipment>();
            equipments = equipmentDAO.GetAll().ToList();

            UsersDAO usersDAO = new UsersDAO();
            List<User> users = new List<User>();
            users = usersDAO.GetAll().ToList();
        ...
        {
            ExercisesDAO excerciseDAO = new ExercisesDAO();
            return excerciseDAO.GetAllFiltered(bodyPart, equipment).ToList();
        }

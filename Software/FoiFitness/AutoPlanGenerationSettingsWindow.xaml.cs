...
namespace FoiFitness
{
    ...
    public partial class AutoPlanGenerationSettingsWindow : Window
    {
        ...
        { 
            ...
            {
                listOfTrainingExercisesInWeek.Add(GenerateExercises(selectedPlanVolume.amplifier, selectedPlanType.name));
            }
        ...
        private List<Training_Exercises> GenerateExercises(int selectePlanVolume, string selectedPlanType)
        {
